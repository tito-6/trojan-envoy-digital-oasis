...
export const contentFormSchema = z.object({
  ...
  type: z.enum(["Page", "Page Section", "Service", "Portfolio", "Blog Post", "Testimonial", "FAQ", "Team Member", "Case Study", "Job Posting", "Technology Stack"] as const),
