...
const translations: Translations = {
  en: {
    ...
    'contact.description': 'Have a project in mind? Let\'s talk about how we can help your business grow through innovative digital solutions.',
    ...
    'contact.addressLine1': '1234 Tech Avenue, Innovation District',
    'contact.addressLine2': 'New York, NY 10001, USA',
    'contact.contactInfo': 'Contact Information',
    'contact.emailLabel': 'Email',
    'contact.phoneLabel': 'Phone',
    'contact.workingHours': 'Working Hours',
    'contact.weekdayHours': 'Monday - Friday: 9:00 AM - 6:00 PM',
    'contact.weekendHours': 'Saturday & Sunday: Closed',
    
    // Careers Section
    'careers.title': 'Join Our Team',
    'careers.subtitle': 'Be part of our mission to create innovative digital solutions',
    'careers.currentOpenings': 'Current Openings',
    'careers.exploreOpportunities': 'Explore our job opportunities and find your perfect role',
    'careers.notFound': 'Job Not Found',
    'careers.notFoundDescription': 'The job listing you are looking for does not exist or is no longer available.',
    'careers.backToJobs': 'Back to All Jobs',
    'careers.apply': 'Apply Now',
    'careers.applyForPosition': 'Apply for',
    'careers.fillOutForm': 'Please fill out the form below to apply for this position.',
    ...
    'careers.resumeFormats': 'Accepted formats: PDF, DOC, DOCX',
    'careers.coverLetter': 'Cover Letter',
    'careers.coverLetterPlaceholder': 'Tell us why you are interested in this position and why you would be a good fit...',
    'careers.coverLetterDescription': 'Briefly explain why you are interested in this position and highlight relevant experience.',
    'careers.submitApplication': 'Submit Application',
    'careers.overview': 'Job Overview',
...
// Create React context to use the language store with React components
...
export const useLanguage = () => {
  ...
  if (!context) {
    // Fallback to direct store when used outside provider
...
if (typeof window !== 'undefined') {
  ...
  if (savedLanguage && availableLanguages.some(lang => lang.code === savedLanguage)) {
    ...
    if (pathSegments.length > 0 && isLanguageCode(pathSegments[0])) {
      useLanguageStore.getState().setLanguage(pathSegments[0]);
    } else {
